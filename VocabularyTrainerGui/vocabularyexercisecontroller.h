...
public:
    VocabularyExerciseController(VocabularyExerciseModel* model);
    virtual ~VocabularyExerciseController();
    void makeGuess(std::string uuid);
    
private:
    VocabularyExerciseController(const VocabularyExerciseController& orig);
};
